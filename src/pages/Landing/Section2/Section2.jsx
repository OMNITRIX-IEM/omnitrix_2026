...
export default function Section2() {
  return (
    <section id="phase-01" className="phase-section relative w-full h-screen flex items-center overflow-hidden px-[80px]">
      {/* Background Layer */}
      ...
      <div className="relative z-10 w-full max-w-container-max mx-auto grid grid-cols-1 md:grid-cols-2 gap-gutter h-full items-center">
        ...
        <div className="col-span-1 flex flex-col justify-center items-start pl-8 xl:pl-16 2xl:pl-24">
          <div className="phase-panel-wrapper ml-[-80px]">
            <div className="phase-panel relative opacity-100 -translate-x-16 xl:-translate-x-24 2xl:-translate-x-32">
              <div className="hud-scan"></div>
              <div className="hud-noise"></div>
              <div className="phase-content">


                <h2 className="phase-heading glitch-title">
                  ABOUT<br />OMNITRIX
                </h2>
