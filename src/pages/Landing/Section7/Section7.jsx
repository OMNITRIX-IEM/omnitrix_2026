...
const FAQ_DATA = [
  {
    number: "01",
    question: "WHAT IS ROBO WARS?",
    answer: "ROBOWARS IS A COMPETITIVE ENGINEERING BATTLEFIELD WHERE TEAMS DEPLOY CUSTOM-BUILT MACHINES AND COMPETE THROUGH STRATEGY, CONTROL AND RAW MECHANICAL POWER."
  },
  {
    number: "02",
