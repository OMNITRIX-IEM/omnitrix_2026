...
pos.array[i3 + 1] =
  ...
  0.4;
        ...
        if (
          ...
          particles.waitTimer[i] =
            4.0 +
            Math.random() *
              5.0;

          particles.captureRadius[i] =
            2.7 +
            (Math.random() - 0.5) *
            1.6;

          particles.captureY[i] =
            (Math.random() - 0.5) *
            0.8;
        }
      }
...
particles.startZ[i] =
  ...
  particles.captureRadius[i];
          ...
          particles.progress[i] =
            0;

          particles.projectSpeed[
            i
          ] =
            0.005 +
            Math.random() *
          ...
          particles.rotation[i] =
            particles.angle[i];

          particles.hemisphere[
            i
          ] =
            Math.random() > 0.5
              ? 1
